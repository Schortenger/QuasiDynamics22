classdef MixedIntegerInstantaneousContactPlacementProblem < Quad_MixedIntegerConvexProgram
% Developed by Bernardo Aceituno-C (MIT MCube Lab)
  ...
  methods
    function obj = MixedIntegerInstantaneousContactPlacementProblem(object, t, sol_prev, n_l, n_c, f)
      ...
      if nargin < 5; n_c = 1; end;
      if nargin < 4; n_l = 2; end;
      ...
      obj = obj.addVariable('alpha_f', 'C', [1, obj.N_c, obj.N_l, obj.N_T], 0, 0.03);
      obj = obj.addVariable('alpha_min', 'C', [1, obj.N_T], 0, 0.1);
    ...
    function obj = addContactConstraints(obj)
      ...
      obj = obj.addVariable('lambda', 'C', [2, obj.N_c, obj.N_l, obj.N_T], 0.3, 1);
    ...
    function obj = addInitialCondiiton(obj, sol_prev)
      ...
      for l = 1:obj.N_l
        for c = 1:obj.N_c
          % fixes fingers
          Aeq = sparse(2,obj.nv);
          beq = sol_prev.vars.p.value(:,c,l,2);
          ...
          % fixes forces
          Aeq = sparse(2,obj.nv);
          beq = sol_prev.vars.f.value(:,c,l,2);
          ...
          beq = sol_prev.vars.L.value(:,c,l,2);;
        ...
        for l = 1:obj.N_l
          for c = 1:obj.N_c
            ...
            for r = 1:length(env_regions)
              ...
              Ai(:,obj.vars.p.i(:,c,l,1)) = env_regions{r}.A;
            ...
            for r = 1:obj.N_r
              ...
              Ai(:,obj.vars.p.i(:,c,l,1)) = A;
              Ai(:,obj.vars.R.i(r,c,l,1)) = K;
    ...
    function obj = addCostFunction(obj)
      ...
      for t = 1:obj.N_T
        % min_marging
        qi = zeros(1,obj.nv);
        qi(1,obj.vars.alpha_min.i(:,t)) = -1000;
        obj = obj.addCost([],qi',[]);
        
        for v = 1:obj.object.nv 
          Qi = sparse(obj.nv,obj.nv);
          Qi(obj.vars.f_ext.i(:,v,1),obj.vars.f_ext.i(:,v,1)) = eye(2);
          % obj = obj.addCost(Qi,[],[]);
        end
        for c = 1:obj.N_c
          for l = 1:obj.N_l  
            Qi = sparse(obj.nv,obj.nv);
            Qi(obj.vars.ddp.i(:,c,l,1),obj.vars.ddp.i(:,c,l,1)) = eye(2);
            % obj = obj.addCost(Qi,[],[]);

            Qi = sparse(obj.nv,obj.nv);
            Qi(obj.vars.f.i(:,c,l,1),obj.vars.f.i(:,c,l,1)) = eye(2);
            obj = obj.addCost(Qi,[],[]);

            Qi = sparse(obj.nv,obj.nv);
            Qi(obj.vars.rel_ddp.i(:,c,l,1),obj.vars.rel_ddp.i(:,c,l,1)) = eye(2);
            obj = obj.addCost(Qi,[],[]);
          end
        end
      end
