...
% Developed by Bernardo Aceituno-C (MIT MCube Lab)
  ...
  methods
    function obj = MixedIntegerContactPlacementProblem(object, n_l, n_c, f)
      ...
      % time integration
      obj = obj.addVariable('dr', 'C', [3, obj.N_T], -inf, inf);
      obj = obj.addVariable('ddr', 'C', [3, obj.N_T], -inf, inf);
      obj = obj.addVariable('dt', 'C', [1, obj.N_T], 0, 1);

      % transformation over time for line segment
      obj = obj.addVariable('t', 'C', [2, obj.N_l, obj.N_T], -inf, inf); % translation
