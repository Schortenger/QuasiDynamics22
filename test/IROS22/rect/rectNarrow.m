...
object = {struct('v',0.39*[-0.25, 0.25, 0.25, -0.25; -1, -1, 1, 1])};
object_verts = 0.39*[-0.25, 0.25, 0.25, -0.25; -1, -1, 1, 1];

% object = {struct('v',0.15*[-1, 1, 0; -1, -1, 0]),struct('v',0.15*[1, -1, 0; 1, 1, 0])};
env = {[1,1;0,1],[1,0.25;1,1],[0.25,0;1,0.6],[0,-0.25;0.6,1],[-0.25,-1;1,1],[-1,-1;1,0],[-1,-0.25;0,0],[-0.25,0;0,0.4],[0,0.25;0.4,0],[0.25,1;0,0]};
