classdef GenSagMotionNCVX
	...
	methods
		function obj = GenSagMotionNCVX(init_,goal,nv)
			% number of vertices
			...
			% obj.traj.r(1,:) = obj.traj.r(1,:) + rand(1, 5)/50;
			% obj.traj.r(2,:) = obj.traj.r(2,:) + rand(1, 5)/50;
			...
			for i = 1:obj.nv
				...
				lines_init{i}.fc1 = rot*[-0.1;1]; 
				lines_init{i}.fc2 = rot*[0.1 ;1];
			end
